...
start_screen_music = pygame.mixer.Sound('sb.mp3')
game_over_music = pygame.mixer.Sound('Starboy.mp3')
...
class Game:
    ...
    def start_text(self):
        ...
        text2 = font2.render('tugas mpp aplikasi sederhana python', True, 'white')
    ...
    def game_over_text(self):
        font = pygame.font.SysFont('Calibri', 50)
        text = font.render('gini aja kalah', True, 'red')
        text_rect = text.get_rect(center=(s_width/2, s_height/2))
        screen.blit(text, text_rect)
